...
<?php include_once dirname(__DIR__)."/backEnd/lib/listeHabitats.php"; ?>
<?php include_once dirname(__DIR__)."/backEnd/lib/rapportVeterinaire.php";  ?>
...
<?php include "/xampp/htdocs/zooArcadia/frontEnd/templates/habitat.php" ?>
