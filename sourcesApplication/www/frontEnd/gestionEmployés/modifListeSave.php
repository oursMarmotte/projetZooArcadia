...
<div class="card feature-icon d-inline-flex text-bg-secondary bg-gradient fs-2 mb-3">
        ...
        <?php foreach($tabUser as $employé): ?>
         ...
         <tr> <td> Nom:<?= $employé['username'] ?></td><td> Email :<?= $employé['email'] ?></td><td><a href="lib/routeurGestion.php?modifUser=<?= $employé['employé_id']?>"><i class="bi bi-trash"></i></a></td><td>modifier le compte</td></tr>
