...
<div class="container px-4 py-5  " id="featured-3">
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-4 d-flex flex-wrap  justify-content-center  bg-light">
      ...
      <div class="card feature-icon d-inline-flex text-bg-success bg-gradient fs-2 mb-3 align-items-center">
      ...
      <div class="card  mb-5 bg-secondary ">
        ...
        <p class="text-light"><?php echo $habitat['habitat_description']; ?></p>
...
<?php if($animal['Id_Habitat']== $idhabitat):?>
      ...
      <div class="card  mb-5">
        ...
        <p ><img class="w-100 h-100" src="/Assets/images/upload/<?php echo $animal['image']; ?>"</p>
