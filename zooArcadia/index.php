<?php define("BASE_URL",'/'); ?>
<?php include_once dirname(__DIR__)."/zooArcadia/backEnd/lib/session.php" ?>
<?php include_once dirname(__DIR__)."/zooArcadia/frontEnd/templates/header.php"  ?>
<?php include_once dirname(__DIR__)."/zooArcadia/backEnd/lib/pdo.php" ?>
<?php require_once dirname(__DIR__)."/zooArcadia/backEnd/lib/class/PiloteAvis.php"; ?>
<?php require_once dirname(__DIR__)."/zooArcadia/backEnd/lib/class/managerAvisBdd.php";?>
<?php 
...
<div class="container  d-flex flex-wrap  justify-content-center px-4 py-5 ps-5 pe-5 ms-10  id="featured-3">
    ...
    <div class= "row g-4 py-5 row-cols-1 row-cols-lg-4 d-flex flex-wrap  justify-content-center bg-light">
      ...
      <button class="btn btn-secondary"><h3 class="fs-2 text-body-emphasis">Nos services</h3></button>
        <div class="card">
      ...
      <div class="feature col bg-white ms-2 me-2 ps-5 pe-5">
        ...
        <button class="btn btn-secondary"><h3 class="fs-2 text-body-emphasis">Nos habitats</h3></button>
        <div class="card">
      ...
      <div class="feature col bg-white ms-2 me-2 ps-5 pe-5">
        ...
        <button  class="btn btn-secondary"><h3 class="fs-2 text-body-emphasis">Nos animaux</h3></button>
        <div class="card">
      ...
      <div class="card col-lg-4 col-md-4 sol-sm-12 ms-5 ps-5 pe-5 bg-white ">
        ...
        <button class="btn btn-secondary"><h3 class="fs-2 text-body-emphasis">Votre avis nous interessent</h3></button>
        <ul>
