...
<div class="card feature-icon d-inline-flex text-bg-secondary bg-gradient fs-2 mb-3">
        <h3 class="fs-2 text-body-emphasis">Ajouter un employé </h3>
        </div>
...
<form action="#" method=>
  ...
  <option value="3" >Employé</option>
        ...
        <div id="contenant"><button  id="ajout-employé" type="submit" value="ajout-employé" class="btn btn-primary">envoyez</button></div>
