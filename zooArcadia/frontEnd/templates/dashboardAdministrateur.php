...
<div class=" col-xxl-8 col-lg-8 col-md-12 col-sm-12 align-items-center justify-content-center card d-flex bg-white  " id="containeur"><h3>Indice de popularité par animal</h3>
<div class="card">
<?php 
fetchAnimalDataMGDB($client)
;?>
</div>
      
</div>
<div class="col-lg-8 col-md-8 col-sm-8 align-items-center justify-content-center card d-flex bg-white  " id="paginationBis"><p></p>
