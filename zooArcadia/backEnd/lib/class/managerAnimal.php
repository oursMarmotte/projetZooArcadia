...
class ManagerAnimal
{
    ...
    public function addPilote(PiloteAnimal $pilote){
       try{
        $statement = $this->pdo->prepare('INSERT INTO animal VALUES (NULL,:firstname,:habitatid,:raceid,:imagepath)');
        ...
        $statement->bindValue(':imagepath',$pilote->getImage(),PDO::PARAM_STR);
